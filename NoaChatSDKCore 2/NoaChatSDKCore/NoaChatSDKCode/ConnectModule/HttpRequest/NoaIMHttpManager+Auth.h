...
//信任设备列表
#define Auth_Trusted_Device_List_Url    @"/auth/trustedDevice/list"
//剔除信任设备
#define Auth_Trusted_Device_Revoke_Url  @"/auth/trustedDevice/revoke"
//清除信任设备异常标记
#define Auth_Trusted_Device_Clear_Anomaly_Url @"/auth/trustedDevice/clearAnomaly"
